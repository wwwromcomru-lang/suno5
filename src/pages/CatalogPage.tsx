...
{ img: book7, title: "Ритм в Suno AI", desc: "Книга о ритме для новичков в музыке. Без теории — всё через понятные слова и готовые промпты.", link: "https://www.suno5.ru/books/7" }];
