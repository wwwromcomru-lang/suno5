    ...
    <section className="hero-bg pt-32 pb-20 md:pt-40 md:pb-28" aria-labelledby="hero-heading">
      <div className="container text-center">
        ...
        <h1 id="hero-heading" className="mt-8 text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-foreground">
          Библиотека промптов
          <br />
          <span className="brand-gradient-text text-2xl">от <a href="https://mastersuno.ru" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">MASTERSUNO.RU</a></span>
        </h1>
